...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-white group/calendar p-3 [--cell-size:2rem] w-full in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent dark:bg-neutral-950",
      ...
      classNames={{
        ...
        dropdown: cn(
          "bg-white absolute inset-0 opacity-0 dark:bg-neutral-950",
...
>): import("react/jsx-runtime").JSX.Element {
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]:bg-neutral-900 data-[selected-single=true]:text-neutral-50 data-[range-middle=true]:bg-neutral-100 data-[range-middle=true]:text-neutral-900 data-[range-start=true]:bg-neutral-900 data-[range-start=true]:text-neutral-50 data-[range-end=true]:bg-neutral-900 data-[range-end=true]:text-neutral-50 group-data-[focused=true]/day:border-neutral-950 group-data-[focused=true]/day:ring-neutral-950/50 flex aspect-square h-auto w-full min-w-[--cell-size] flex-col gap-1 font-normal leading-none data-[range-end=true]:rounded-md data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-md group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] [&>span]:text-xs [&>span]:opacity-70 dark:data-[selected-single=true]:bg-neutral-50 dark:data-[selected-single=true]:text-neutral-900 dark:data-[range-middle=true]:bg-neutral-800 dark:data-[range-middle=true]:text-neutral-50 dark:data-[range-start=true]:bg-neutral-50 dark:data-[range-start=true]:text-neutral-900 dark:data-[range-end=true]:bg-neutral-50 dark:data-[range-end=true]:text-neutral-900 dark:group-data-[focused=true]/day:border-neutral-300 dark:group-data-[focused=true]/day:ring-neutral-300/50",
        defaultClassNames.day,
        className,
      )}
      {...props}
